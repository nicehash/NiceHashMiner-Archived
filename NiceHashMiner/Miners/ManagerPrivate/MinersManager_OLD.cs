...
//    public partial class MinersManager_OLD : BaseLazySingleton<MinersManager_OLD> {
...
//        List<SortedSet<string>> _previousAllGroupedDevices;
//        List<SortedSet<string>> _currentAllGroupedDevices;
