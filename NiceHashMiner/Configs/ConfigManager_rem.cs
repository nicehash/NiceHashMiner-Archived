...
namespace NiceHashMiner.Configs {
    public partial class ConfigManager_rem : BaseLazySingleton<ConfigManager_rem> {
        public GeneralConfigHandler GeneralConfig { get; set; }
        public Dictionary<string, DeviceBenchmarkConfig_rem> BenchmarkConfigs { get; set; }

        private readonly string TAG;

        // constructor has references don't delete it
        protected ConfigManager_rem() {
            TAG = this.GetType().Name;
            GeneralConfig = new GeneralConfigHandler(true);
            BenchmarkConfigs = new Dictionary<string, DeviceBenchmarkConfig_rem>();
        }
